  ...
  return (
    <>
      <header className="mast">
        ...
        <a className="gh install-mark" href={STORE_URL} target="_blank" rel="noopener noreferrer"
           aria-label="Add Chickadee to Chrome" title="Add to Chrome — free on the Chrome Web Store">
          <svg viewBox="0 0 24 24" width="17" height="17" fill="none" stroke="currentColor"
               strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            <path d="M12 3.5v10.5" />
            <path d="M8.2 10.4 12 14.2l3.8-3.8" />
            <path d="M4.5 15v3.2c0 1 .8 1.8 1.8 1.8h11.4c1 0 1.8-.8 1.8-1.8V15" />
          </svg>
        </a>
        </span>
      </header>
